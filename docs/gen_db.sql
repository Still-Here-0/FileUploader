...
CREATE TABLE uploader.COLUMN_TYPE (
	pk int IDENTITY(1,1) NOT NULL,
	SqlType varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	ViewType varchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
CREATE TABLE uploader.HIST_SHEET (
	...
	EditAction varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
CREATE TABLE uploader.WORKER (
	...
	LindeId char(6) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
CREATE TABLE uploader.HIST_SHEET_META_DATA (
	...
	Optional bit NULL,
	RegexConstraint varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	EditedBy_fk varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	EditAction varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	EditedAt datetime DEFAULT getdate() NOT NULL
);
...
CREATE TABLE uploader.HIST_UPLOADER_PERMISSION (
	...
	ActionHist varchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	EditedAt datetime DEFAULT getdate() NOT NULL
);
...
CREATE TABLE uploader.SHEET_META_DATA (
	...
	RegexConstraint varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS DEFAULT NULL NULL,
	LastEditedBy_fk int NOT NULL,
	pk int IDENTITY(1,1) NOT NULL,
...
-- uploader.UPLOADS definition

-- Drop table

-- DROP TABLE uploader.UPLOADS;

CREATE TABLE uploader.UPLOADS (
	Sheet_fk int NOT NULL,
	FileUploaded varbinary(MAX) NOT NULL,
	UploadedAt datetime DEFAULT getdate() NOT NULL,
	UploadedBy_fk int NOT NULL,
	SheetUsed varchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS DEFAULT NULL NULL,
	CONSTRAINT UPLOADS_PROFILE_FK FOREIGN KEY (UploadedBy_fk) REFERENCES uploader.PROFILE(pk),
	CONSTRAINT UPLOADS_SHEET_FK FOREIGN KEY (Sheet_fk) REFERENCES uploader.SHEET(pk)
);
